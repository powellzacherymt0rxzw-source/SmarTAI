...
> **同日最新覆盖：** 用户随后确认“上传作答”只负责文件与身份识别，批改模型/评分策略移到第 6“执行批改”；校对页增加可持久化“已复核”，C02 增加 5 秒自动开始摘要。本文件中“上传作答内部两阶段”和“先保存设置再识别”的内容仅保留为历史。最新决定与合同见 `docs/20260727/S01_S05_C01_C02_SUBMISSION_TO_GRADING_REALIGNMENT_STAGE_CN.md`。
