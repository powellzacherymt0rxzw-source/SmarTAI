...
- [x] P4-03 新增批量导入资料 UI 外壳：知识库文件/分组/全部库、上传并加入知识库。完成：2026-07-08 16:12；新增批量导入资料入口，覆盖导入内容、资料来源和文件结构选择，按钮保持禁用并说明题号匹配、长文档检索、OCR、匹配置信度和逐题回填需要后端 job。
...
- [x] P6-05 运行 `npm run typecheck`。完成：2026-07-04 09:59；本轮复测通过：2026-07-05 15:13、2026-07-08 16:17。
- [x] P6-06 运行 `npm run build`。完成：2026-07-04 09:59；本轮复测通过：2026-07-05 15:14、2026-07-08 16:17。
